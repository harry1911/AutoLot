...
namespace AutoLot.Dal.Initialization
{
    public static class SampleData
    {
        public static List<Customer> Customers =>
            new List<Customer> 
            {
                new Customer {Id = 1, PersonalInformation = new Person{FirstName = "Dave", LastName =
                "Brenner"}},
                new Customer {Id = 2, PersonalInformation = new Person{FirstName = "Matt", LastName =
                "Walton"}},
                new Customer {Id = 3, PersonalInformation = new Person{FirstName = "Steve", LastName =
                "Hagen"}},
                new Customer {Id = 4, PersonalInformation = new Person{FirstName = "Pat", LastName =
                "Walton"}},
                new Customer {Id = 5, PersonalInformation = new Person{FirstName = "Bad", LastName =
                "Customer"}},
            };
